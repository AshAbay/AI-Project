...
public class FindRightAnswer {
    ...
    public FindRightAnswer(ArrayList<String> wikiUrls, String searchString) throws IOException {
    ...
    public static void main (String[] args) throws IOException, ParseException {
        ...
        FindRightAnswer rightAnswer = new FindRightAnswer(test.getWikiUrls(), searchString);
